...
public final class NumberAxis extends ValueAxis<Number> {
    ...
    @Override protected void setRange(Object range, boolean animate) {
        ...
        System.out.println("NumberAxis::setRange(): lower bound:"+lowerBound+"  upper bound:"+upperBound+ "  Tick unit"+tickUnit);
    ...
    @Override protected List<Number> calculateTickValues(double length, Object range) {
        ...
        System.out.println("NumberAxis::calculateTickValues(): n:"+tickValues.size()+" first:"+tickValues.get(0)+ "  last:"+tickValues.get(tickValues.size()-1));
    ...
    @Override protected Object autoRange(double minValue, double maxValue, double length, double labelSize) {
        ...
        System.out.println("NumberAxis::autoRange(): minRounded:"+minRounded+" maxRounded:"+maxRounded+ "  tickUnitRounded:"+tickUnitRounded +" newScale"+newScale+"  rangeIndex"+rangeIndex);
